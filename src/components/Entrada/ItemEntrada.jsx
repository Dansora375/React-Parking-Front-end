...
function ItemEntrada(props) {
  ...
  React.useEffect(()=>{
    ...
    setDateconvert(dateTime)
    setTimeconvert(dateString)
  },[])
  ...
  // const Time = entryTime.getDate()+'/'+(Number(entryTime.getMonth())+1)+'/'+entryTime.getFullYear()
  // conditions
